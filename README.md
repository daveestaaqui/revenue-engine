# Surplus Docket™ — Autonomous Public Records Intelligence Engine
...
### 📊 Live Pipeline Statistics *(Updated August 24, 2026)*

| Metric | Active Production Value | Statutory Provenance |
| :--- | :--- | :--- |
| **Active Monitored Surplus** | **$1,672,200.00 USD** | Florida, Texas & Georgia District/Circuit Dockets |
| **Available Statutory Fees** | **$354,100.00 USD** | Governed by Fla. Stat. § 197.582 & Tex. Tax Code § 34.04 |
| **Active Indexed Records** | **22 Verified Cases** | 100% Pre-filtered (Institutional Liens Removed) |
